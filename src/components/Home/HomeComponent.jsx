        ...
        <div className="container mx-auto ">
            ...
            >
                <div className="">
                    ...
                    <p className="font-IBM text-xl text-fedora mt-4 lg:text-3xl">Aspiring Web Developer - Photographer </p>
                    <p className="font-Quicksand tracking-wide lg:text-xl mt-3">I am a recent graduate of NuCamp's full stack online progamming bootcamp learning technologies like Bootstrap, JavaScript, React, and much more!
